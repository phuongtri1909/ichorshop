    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <!-- Quản lý sản phẩm -->
                <li class="has-submenu {{ Route::currentRouteNamed(['admin.brands.*', 'admin.categories.*', 'admin.products.*', 'admin.product-variants.*', 'admin.dress-styles.*']) ? 'open' : '' }}">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="{{ Route::currentRouteNamed('admin.products.*','admin.product-variants.*') ? 'active' : '' }}">
                ...
                <!-- Quản lý bán hàng -->
                <li class="has-submenu {{ Route::currentRouteNamed(['admin.orders.*', 'admin.promotions.*']) ? 'open' : '' }}">
                    <a href="#" class="submenu-toggle">
                ...
                <!-- Quản lý nội dung -->
                <li class="has-submenu {{ Route::currentRouteNamed(['admin.news.*', 'admin.banners.*']) ? 'open' : '' }}">
                    <a href="#" class="submenu-toggle">
                ...
                <!-- Quản lý tương tác -->
                <li class="has-submenu {{ Route::currentRouteNamed(['admin.contacts.*', 'admin.reviews.*']) ? 'open' : '' }}">
                    <a href="#" class="submenu-toggle">
                ...
                <!-- Cấu hình hệ thống -->
                <li class="has-submenu {{ Route::currentRouteNamed(['admin.socials.*', 'admin.logo-site.*']) || request()->is('admin/users*') || request()->is('admin/settings*') ? 'open' : '' }}">
                    <a href="#" class="submenu-toggle">

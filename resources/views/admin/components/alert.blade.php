...
{{-- 
    ...
    @include('admin.components.alert', ['alertType' => 'modal'])
    
    Truyền thông báo trực tiếp:
    @include('admin.components.alert', ['success' => 'Thao tác thành công!'])
    
    Tùy chỉnh thời gian tự động đóng:
    @include('admin.components.alert', ['autoCloseTime' => 3000])
    
    Tắt tính năng tự động đóng:
    @include('admin.components.alert', ['autoClose' => false])
    
    Tắt nút đóng:
    @include('admin.components.alert', ['dismissible' => false])
--}}
...
@section('title', 'Quản lý liên hệ nhượng quyền')
    ...
    <div class="category-container">
        ...
        <div class="content-breadcrumb">
            <ol class="breadcrumb-list">
                ...
                <li class="breadcrumb-item current">Liên hệ nhượng quyền</li>
            </ol>
        </div>
        ...
        <div class="content-card">
            <div class="card-top">
                <div class="card-title">
                    ...
                    <h5>Danh sách liên hệ nhượng quyền</h5>
                </div>
            </div>

            <!-- Filter Section -->
            <div class="filter-section">
                <form action="{{ route('admin.franchise-contacts.index') }}" method="GET" class="filter-form">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('admin.franchise-contacts.index') }}" class="filter-clear-btn">
            ...
            <div class="card-content">
                ...
                @if ($contacts->isEmpty())
                    <div class="empty-state">
                        ...
                        @if (request('contact_id') || request('customer') || request('status') || request('date_from') || request('date_to'))
                            <h4>Không tìm thấy liên hệ nhượng quyền nào</h4>
                            <p>Không có liên hệ nhượng quyền nào phù hợp với bộ lọc hiện tại.</p>
                            <a href="{{ route('admin.franchise-contacts.index') }}" class="action-button">
                                <i class="fas fa-times"></i> Xóa bộ lọc
                            </a>
                        @else
                            <h4>Chưa có liên hệ nhượng quyền nào</h4>
                            <p>Hiện chưa có liên hệ nhượng quyền nào trong hệ thống.</p>
                        @endif
                    </div>
                @else
                        ...
                        <table class="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="column-medium">Gói nhượng quyền</th>
                                    <th class="column-small">Ngày đăng ký</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="customer-info">
                                                <span class="customer-name">{{ $contact->first_name }}
                                                    {{ $contact->last_name }}</span>
                                                <span class="customer-email">{{ $contact->email }}</span>
                                            </div>
                                        </td>
                                        <td>{{ $contact->phone }}</td>
                                        <td>
                                            @if($contact->franchise)
                                                <span class="franchise-package">{{ $contact->franchise->name_package }}</span>
                                            @else
                                                <span class="franchise-not-exist">Gói không tồn tại</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="action-buttons-wrapper">
                                                <a href="{{ route('admin.franchise-contacts.show', $contact->id) }}"
                                            ...
                                            @include('admin.components.delete-form', [
                                                'id' => $contact->id,
                                                'route' => route('admin.franchise-contacts.destroy', $contact),
                                                'message' => "Bạn có chắc chắn muốn xóa liên hệ nhượng quyền này?",
                                            ])
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="pagination-wrapper">
                        <div class="pagination-info">
                            ...
                            {{ $contacts->total() }} liên hệ nhượng quyền
                        </div>

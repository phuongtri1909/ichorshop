    ...
    <div class="category-form-container">
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form action="{{ route('admin.promotions.update', $promotion) }}" method="POST" class="promotion-form" id="promotion-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label for="discount_type" class="form-label required">Loại giảm giá</label>
                                <select id="discount_type" name="discount_type" class="custom-select" required>
                                    ...
                                    <option value="fixed" {{ old('discount_type', $promotion->discount_type) == 'fixed' ? 'selected' : '' }}>Số tiền cố định (đ)</option>
                                </select>
                                <div class="error-message" id="discount_type-error"></div>
                            </div>

                            <div class="form-group">
                                <label for="discount_value" class="form-label required">Giá trị giảm</label>
                                <div class="input-group">
                                    <input type="number" id="discount_value" name="discount_value" class="custom-input" 
                                           placeholder="0" value="{{ old('discount_value', $promotion->discount_value) }}" min="0" step="0.01" required>
                                    <span class="input-suffix" id="discount-suffix">{{ $promotion->discount_type == 'percentage' ? '%' : 'đ' }}</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" id="min_order_amount" name="min_order_amount" class="custom-input" 
                                           placeholder="0" value="{{ old('min_order_amount', $promotion->min_order_amount) }}" min="0" step="1000">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" id="max_discount_amount" name="max_discount_amount" class="custom-input" 
                                           placeholder="0" value="{{ old('max_discount_amount', $promotion->max_discount_amount) }}" min="0" step="1000">
                                    <span class="input-suffix">đ</span>
                                </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="usage_limit" name="usage_limit" class="custom-input" 
                                   placeholder="Để trống nếu không giới hạn" value="{{ old('usage_limit', $promotion->usage_limit) }}" min="1">

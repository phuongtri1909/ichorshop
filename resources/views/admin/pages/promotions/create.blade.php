    ...
    <div class="category-form-container">
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form action="{{ route('admin.promotions.store') }}" method="POST" class="promotion-form"
                    id="promotion-form">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <select id="type" name="type" class="form-select" required>
                                    ...
                                    <option value="percentage" {{ old('type') == 'percentage' ? 'selected' : '' }}>
                                        Phần trăm (%)</option>
                                    <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Số tiền
                                        cố định ($)</option>
                                </select>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" id="value" name="value" class="custom-input" placeholder="0"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" id="min_order_amount" name="min_order_amount" class="custom-input"
                                        placeholder="0" value="{{ old('min_order_amount') }}" min="0" step="1">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" id="max_discount_amount" name="max_discount_amount"
                                        class="custom-input" placeholder="0" value="{{ old('max_discount_amount') }}"
                                        min="0" step="1">
                                    <span class="input-suffix">$</span>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <input type="number" id="usage_limit" name="usage_limit" class="custom-input"
                                    placeholder="Để trống nếu không giới hạn" value="{{ old('usage_limit') }}"
                                    min="1">

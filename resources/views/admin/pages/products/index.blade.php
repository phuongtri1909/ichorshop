                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select id="category_filter" name="category_id" class="form-select filter-input">
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                <label for="brand_filter" class="form-label">Thương hiệu</label>
                                <select id="brand_filter" name="brand_id" class="form-select filter-input">
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                <label for="name_filter" class="form-label">Tên sản phẩm</label>
                                <input type="text" id="name_filter" name="name" class="form-control filter-input"
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select id="status_filter" name="status" class="form-select filter-input">
                                    <option value="">Tất cả trạng thái</option>
                                    <option value="active" {{ request('status') == 'active' ? 'selected' : '' }}>Đang bán
                                    </option>
                                ...
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td class="product-image">
                                            @if ($product->avatar)
                                                <img src="{{ $product->avatar_medium_url }}" alt="{{ $product->name }}"
                                                    class="thumbnail">
                                            @else
                                                <div class="no-image">
                                        ...
                                        <td class="item-name">
                                            ...
                                            @if ($product->description_short)
                                                <div class="product-desc">{{ Str::limit($product->description_short, 60) }}
                                                </div>
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            @if ($product->categories->count() > 0)
                                                <div class="category-tags">
                                                    ...
                                                    @if ($product->categories->count() > 2)
                                                        <span
                                                            class="category-tag more">+{{ $product->categories->count() - 2 }}</span>
                                                    @endif
                                                </div>
                                            @else

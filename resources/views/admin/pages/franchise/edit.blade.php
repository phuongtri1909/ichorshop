...
@section('title', 'Chỉnh sửa gói nhượng quyền')
        ...
        <div class="form-card">
            <div class="form-header">
                <div class="form-title">
                    ...
                    <h5>Chỉnh sửa gói nhượng quyền</h5>
                </div>
                <div class="franchise-meta">
                    <div class="franchise-badge slug">
                        <i class="fas fa-link"></i>
                        <span>{{ $franchise->slug }}</span>
                    </div>
                    <div class="franchise-badge code">
                        <i class="fas fa-fingerprint"></i>
                        <span>{{ $franchise->code }}</span>
                    </div>
                    <div class="franchise-badge created">
                        <i class="fas fa-calendar"></i>
                        <span>Ngày tạo: {{ $franchise->created_at->format('d/m/Y H:i') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-body">
                ...
                <form action="{{ route('admin.franchise.update', $franchise) }}" method="POST" class="franchise-form"
                    id="franchise-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-tabs">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="name" value="{{ old('name', $franchise->name) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="custom-input {{ $errors->has('name_package') ? 'input-error' : '' }}"
                                        id="name_package" name="name_package"
                                        value="{{ old('name_package', $franchise->name_package) }}">
                                    <div class="error-message">
                                        @error('name_package')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="custom-input {{ $errors->has('code') ? 'input-error' : '' }}" id="code"
                                        name="code" value="{{ old('code', $franchise->code) }}"
                                        placeholder="Nhập mã gói hoặc để trống để tự động tạo">
                                    <div class="form-hint">
                                        <i class="fas fa-info-circle"></i>
                                        <span>Để trống để tự động tạo từ tên gói</span>
                                    </div>
                                    <div class="error-message">
                                        @error('code')
                                            {{ $message }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        class="custom-input {{ $errors->has('sort_order') ? 'input-error' : '' }}"
                                        id="sort_order" name="sort_order"
                                        value="{{ old('sort_order', $franchise->sort_order) }}" min="0">
                                    <div class="error-message">
                                        @error('sort_order')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="editor">{{ old('description', $franchise->description) }}</textarea>
                            <div class="error-message">
                                @error('description')
                                    {{ $message }}
                                @enderror
                            ...
                            <div class="details-container">
                                <div id="details-items-container">
                                    @if(old('detail_items'))
                                        ...
                                        @endforeach
                                    @elseif(!empty($franchise->detailItems))
                                        @foreach($franchise->detailItems as $index => $item)
                                            <div class="detail-item row mb-3">
                                                <div class="col-md-10">
                                                    <textarea class="detail-editor" id="detail_items_{{ $index }}" name="detail_items[{{ $index }}]">{{ $item }}</textarea>
                                                </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Khởi tạo CKEditor cho các đặc điểm
            initDetailEditors();
            ...
            // Xử lý thêm chi tiết đặc điểm - tương tự như trong create.blade.php

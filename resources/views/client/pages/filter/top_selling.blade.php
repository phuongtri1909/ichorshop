...
@section('description',
    'Explore our top sale items and get the best deals. Shop now for exclusive discounts on the latest fashion!')
@section('keywords', 'top sales, discounts, deals, exclusive offers, sale items')

@section('content')

    @include('components.breadcrumb', [
        'items' => [['title' => 'Home', 'url' => route('home')], ['title' => 'Top Sales', 'active' => true]],
        'background' => '',
    ])
